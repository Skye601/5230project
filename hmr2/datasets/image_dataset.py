...
class ImageDataset(Dataset):
    ...
    def load_tars_as_webdataset(cfg: CfgNode, urls: str|List[str], train: bool,
        ...
        # for x in dataset:
        #     ImageDataset.process_webdataset_tar_item(x, train,
    ...
    def process_webdataset_tar_item(item, train, 
        ...
        # Crop image and (possibly) perform data augmentation
        img_rgba = np.concatenate([image, mask.astype(np.uint8)[:,:,None]*255], axis=2) # H, W, 4
        ...
        img_patch = img_patch_rgba[:3,:,:] # 3, H, W
